...
if(isset($_POST['command_cmd'])) { 
   $string = "cmd,";
   $string .= $_POST['command_txt'];
   UploadDevicesTask($connect , $xxid , $string);
   unset($_POST);
   unset($_POST['command_cmd']);
   unset($_POST['command_txt']);
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Command Prompt | mCore Dashboard</title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Command Prompt</h4>
                    </div>
                            ...
                            <div class="card-body">          
                                ...
                                <form method="post">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea id="command_txt" name="command_txt" class="form-control p-0 border-0"></textarea>
                                        </div>
                                    </div>
                                 <?php         
                                  if(DevicesStatus($connect, $xxid) == "Online"){
                                     echo '<input class="btn btn-success" type="submit" id="command_cmd" name="command_cmd" class="fxt-btn-fill" value="Send Command"/>';
                                   }
                          
                          
                                  if(DevicesStatus($connect, $xxid) == "Offline"){
                                    echo '<input class="btn btn-success" type="submit" id="command_cmd" name="command_cmd" class="fxt-btn-fill" value="Send Command"/ disabled>';
                                  }  
                                ?>
                                </form>
                            </div>
