...
<head>
    ...
    <title>Running Applications | mCore Dashboard</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php         
                          if(DevicesStatus($connect, $xxid) == "Online"){
                             echo '<input class="btn btn-success" type="submit" id="command_kill" name="command_kill" value="Kill Process" style="margin-top: 10px;">';
                          }
                          
                          if(DevicesStatus($connect, $xxid) == "Offline"){
                            echo '<input class="btn btn-success" type="submit" id="command_kill" name="command_kill" value="Kill Process" style="margin-top: 10px;" disabled>';
                          }  
                          ?>
                        </form>
                        </div>
