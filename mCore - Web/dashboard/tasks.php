...
<head>
    ...
    <title>Tasks | mCore Dashboard</title>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">OPEN URL</h3>
                              <textarea id="command_urltxt" name="command_urltxt" class="form-control p-0 border-0" style="margin-top: 0px; height: 98px; background: rgb(237, 241, 245); margin-bottom: 10px;"></textarea>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                            <?php         
                              if(DevicesStatus($connect, $xxid) == "Online"){
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">MESSAGEBOX</h3>
                             <textarea id="command_txt" name="command_messagetxt" class="form-control p-0 border-0" style="margin-top: 0px; height: 93px; background: rgb(237, 241, 245); margin-bottom: 10px;"></textarea>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                            <?php         
                              if(DevicesStatus($connect, $xxid) == "Online"){
